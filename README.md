...
| 23 | [KKenny0/Tracework](https://github.com/KKenny0/Tracework) | 2 | Python | 2026-07-23 | Agentic coding decision replay：记录为什么，把 session signals 逐层收口成可核验的周报、月报和路线图。 |
| 24 | [tjq001/hv-code-templates](https://github.com/tjq001/hv-code-templates) | 0 | HTML | 2026-07-23 | Ship Atomic Commits & Retain Workflow Knowledge: Best Free Zero-Dependency Dev Kit 2026 |
...
| 32 | [raelli/octowiz](https://github.com/raelli/octowiz) | 2 | Python | 2026-07-23 | Octowiz gives Claude Code agents memory-backed engineering doctrine — cached by role, refreshed by project state, and ro |
| 33 | [codeswithroh/tastemaker](https://github.com/codeswithroh/tastemaker) | 45 | Python | 2026-07-23 | A Claude Code skill that grounds AI-generated UI in real reference images and a persistent per-developer taste profile,  |
| 34 | [dreamid27/frontend-slides](https://github.com/dreamid27/frontend-slides) | 1 | HTML | 2026-07-23 | Claude Code skill for stunning, animation-rich HTML presentations — 88 layout presets + 34 bold templates. Build slides  |
...
| 36 | [emaballarin/ccplugins](https://github.com/emaballarin/ccplugins) | 2 | Python | 2026-07-23 | Personal plugins for Claude Code (& friends)... maybe worth sharing! |
...
| 39 | [JBSag/pm-artisan](https://github.com/JBSag/pm-artisan) | 0 | HTML | 2026-07-23 | 15 Claude Code PM Skills 2026 - Generate DOCX XLSX PPTX Artifacts Instantly |
| 40 | [Ford-1/postgresql-mcp-connector](https://github.com/Ford-1/postgresql-mcp-connector) | 1 | HTML | 2026-07-23 | PostgreSQL MCP 2026 Best AI Database Access Tool for Developers |
| 41 | [munexor/seo-opportunity-nexus](https://github.com/munexor/seo-opportunity-nexus) | 0 | HTML | 2026-07-23 | SEO Superpower 2026: Bootstrap, Audit & Refresh Stale Content with Free GSC Tools |
| 42 | [alexpilotto/splitlaunch-dev](https://github.com/alexpilotto/splitlaunch-dev) | 0 | — | 2026-07-23 | Package-first A/B testing MCP server for PPC and paid social landing pages. Create URL experiments for Google Ads and Me |
...
| 45 | [LilityV/multai-ai-agent-arsenal](https://github.com/LilityV/multai-ai-agent-arsenal) | 0 | HTML | 2026-07-23 | MultAI Agent 2026: Autonomous Browser Engine with 7 AI Fallbacks & Comparator |
| 46 | [hieu5882/telos-customer-validator](https://github.com/hieu5882/telos-customer-validator) | 0 | HTML | 2026-07-23 | The Art of Customer Validation: 2026’s Overlooked Startup Growth Filter |
...
| 48 | [UiPath/coder_eval](https://github.com/UiPath/coder_eval) | 105 | Python | 2026-07-23 | Evaluate & benchmark AI coding agents and Claude Code skills — sandboxed, reproducible YAML eval suites for Claude Code, |
| 49 | [TABARC-Code/Forensic-Writing-Style-Analysis-Cloning-Claude-Skill](https://github.com/TABARC-Code/Forensic-Writing-Style-Analysis-Cloning-Claude-Skill) | 1 | — | 2026-07-22 | Forensic Writing Style Analysis & Cloning Claude Skill - Clone an Author tone and style and have Claude code write in th |
| 50 | [JhoseWolf/sageox-hivemind-engine](https://github.com/JhoseWolf/sageox-hivemind-engine) | 1 | HTML | 2026-07-22 | ⚡ SageOx HiveMind 2026 — Agentic Engineering Toolkit for Autonomous Workflows |
<!-- TRACKER_TABLE_END -->
