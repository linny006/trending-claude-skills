...
| 20 | [LilityV/multai-ai-agent-arsenal](https://github.com/LilityV/multai-ai-agent-arsenal) | 0 | HTML | 2026-07-29 | MultAI Agent 2026: Autonomous Browser Engine with 7 AI Fallbacks & Comparator |
| 21 | [dltkddns833/ko-official-doc-style](https://github.com/dltkddns833/ko-official-doc-style) | 1 | — | 2026-07-29 | Claude Code skill for Korean official document writing standards (한국 공적문서 작성 기준) — 조문 체계·날짜·금액 표기, 문장부호, 띄어쓰기 |
| 22 | [sjh9714/same-frame](https://github.com/sjh9714/same-frame) | 0 | Python | 2026-07-29 | Agent skill for Claude Code & Codex: re-render an image under new light, palette or medium with the composition intact.  |
...
| 27 | [shauryalowkeygotaura/brand-launchpad](https://github.com/shauryalowkeygotaura/brand-launchpad) | 2 | HTML | 2026-07-29 | One Claude Code skill that turns a single project into a complete brand launch — 12 files (positioning, hero line, 30-da |
| 28 | [hfjddjksaj/auto-git](https://github.com/hfjddjksaj/auto-git) | 0 | PowerShell | 2026-07-29 | Claude Code skill: per-round git auto-commit safety net with progress tracking (cross-platform Stop hooks) |
| 29 | [reem-plus/quiver-compass](https://github.com/reem-plus/quiver-compass) | 1 | HTML | 2026-07-29 | GTM Research & Competitive AI Toolkit 2026 - Raine Soriano |
| 30 | [easyinplay/harnessed](https://github.com/easyinplay/harnessed) | 2 | TypeScript | 2026-07-29 | AI coding harness composition orchestrator — manifest-described upstreams, composition skill workflows. Apache-2.0. |
...
| 32 | [Lx050/rubbing-to-knowledge](https://github.com/Lx050/rubbing-to-knowledge) | 0 | Python | 2026-07-29 | 书生国智科探挑战赛 · 赛道六 AI for Social Science · 古代碑帖与拓片 — 可复现证据链科研 Skill 系统:12 个离线、确定性、纯标准库 Skill(哑舍小分队 · 西北大学) |
| 33 | [lecutu/DeepSeek-PPT-skill](https://github.com/lecutu/DeepSeek-PPT-skill) | 1 | Python | 2026-07-29 | DeepSeek PPT — AI-native PowerPoint generation. Constraint solver closes the loop so LLMs don't need vision |
| 34 | [hieu5882/telos-customer-validator](https://github.com/hieu5882/telos-customer-validator) | 1 | HTML | 2026-07-29 | The Art of Customer Validation: 2026’s Overlooked Startup Growth Filter |
| 35 | [bokyostudio/pg-practice-knowledgebase](https://github.com/bokyostudio/pg-practice-knowledgebase) | 0 | HTML | 2026-07-29 | The Ultimate guide to PostgreSQL Optimization for AI Code Generation in 2026 |
| 36 | [alexzvency-ship-it/claude-browser-automator](https://github.com/alexzvency-ship-it/claude-browser-automator) | 1 | HTML | 2026-07-29 | Top Playwright Test Automation Framework 2026 - Run AI Browser Scripts Instantly |
| 37 | [askimo-ai/askimo](https://github.com/askimo-ai/askimo) | 268 | Kotlin | 2026-07-29 | AI Client for chat, RAG, plans, MCP tools, and agents with multi-provider model support.  |
| 38 | [lemur47/si-protocols](https://github.com/lemur47/si-protocols) | 2 | Python | 2026-07-29 | The Project VEGA — The tooling project for psychic and spiritual counterintelligence. Open-source tools to detect and au |
| 39 | [boshu2/agentops](https://github.com/boshu2/agentops) | 414 | Go | 2026-07-29 | The operating loop a coding agent follows — and skills to orchestrate multi-agent systems. |
...
| 41 | [gaia-react/gaia](https://github.com/gaia-react/gaia) | 20 | Shell | 2026-07-29 | The Claude-native foundation you build your whole app on. React frontend handled, your backend builds on top. Strict too |
...
| 44 | [staskh/trading_skills](https://github.com/staskh/trading_skills) | 299 | Python | 2026-07-29 | Claude powered advisor system for option traders |
...
| 47 | [ikonushok/agent-pack-designer](https://github.com/ikonushok/agent-pack-designer) | 5 | Python | 2026-07-29 | Design minimal AI agent packs for Codex and Claude from project descriptions. |
| 48 | [nevenincs/vaultspec-core](https://github.com/nevenincs/vaultspec-core) | 1 | Python | 2026-07-29 | A spec-driven harness for coding agents (and, humans) |
| 49 | [bloodyburger/skillsmith](https://github.com/bloodyburger/skillsmith) | 0 | Python | 2026-07-29 | Forged Claude Skills that turn Claude into a specialist, not a summarizer. Install via claude.ai ZIP, Claude Code plugin |
| 50 | [mohamoudj6-del/AlterLab-FC-Agent-Playbook](https://github.com/mohamoudj6-del/AlterLab-FC-Agent-Playbook) | 1 | HTML | 2026-07-29 | AlterLab FC 2026 AI Playbook 🚀 Ultimate Skills & Strategy Guide |
<!-- TRACKER_TABLE_END -->
