...
| 16 | [theAnirudhKumar/meeting-design](https://github.com/theAnirudhKumar/meeting-design) | 1 | Python | 2026-09-01 | Design the meeting before you run it. An AI skill that names the decision, picks the decision rule, cuts the room, and p |
| 17 | [theAnirudhKumar/work-design](https://github.com/theAnirudhKumar/work-design) | 0 | Python | 2026-09-01 | Design the work before you do it. AI skills for the moments where one deliberate decision saves the rework: vetting a to |
...
| 19 | [CSPulse/customer-success-skills](https://github.com/CSPulse/customer-success-skills) | 1 | Python | 2026-09-01 | Thirty-two AI skills covering the whole of customer success work: reading an account, running the set-piece moments, han |
...
| 27 | [zx029w/zhuangxiu-skills](https://github.com/zx029w/zhuangxiu-skills) | 44 | Python | 2026-09-01 | 37个装修避坑独立Skill合集 — 覆盖全屋定制、老房改造、合同审核、报价审核、方案诊断、环保避坑、流程管控、翻车急救、避坑问答、增项避雷、公司选择等装修全流程 |
| 28 | [AnotherSava/claude-code-common](https://github.com/AnotherSava/claude-code-common) | 0 | Shell | 2026-09-01 | Complete Claude Code environment: global guidelines, skills, hooks, settings, version-controlled memory and learnings, a |
| 29 | [LarrySequino/skills](https://github.com/LarrySequino/skills) | 0 | Python | 2026-09-01 | Skills I wrote for Claude. Published from a private working library. |
| 30 | [fishzjp/qa-skills](https://github.com/fishzjp/qa-skills) | 19 | Python | 2026-09-01 | 让 AI 像资深测试工程师一样工作：面向 AI Agent 的测试工程 Skill 框架——10 Skills + 共享知识库 + 类型决策矩阵（Claude Code / dsh 等 Agent 可用） |
| 31 | [salimramirez/agent-skills](https://github.com/salimramirez/agent-skills) | 3 | TypeScript | 2026-09-01 | A collection of Agent Skills for AI coding agents — starting with Domain-Driven Design (DDD). |
| 32 | [Fiskopoi/outline-driven-toolkit](https://github.com/Fiskopoi/outline-driven-toolkit) | 2 | HTML | 2026-09-01 | Best AI Code Architect 2026: Diagram-First Agent Orchestrator with AST Editing & Atomic Commits |
| 33 | [filippolmt/skills](https://github.com/filippolmt/skills) | 1 | JavaScript | 2026-09-01 | Claude Code plugin marketplace — install skills individually (one skill per plugin). External skills are referenced upst |
...
| 36 | [zeikar/hyperclaude](https://github.com/zeikar/hyperclaude) | 3 | JavaScript | 2026-09-01 | Claude Code plugin: Claude builds, Codex critiques — a gated research → plan → review → ship pipeline, with autonomous m |
| 37 | [Thelavdevawasthi/claude-git-skills](https://github.com/Thelavdevawasthi/claude-git-skills) | 0 | — | 2026-09-01 | GitHub's one-line description field (top of repo page) shows up in search results and trending lists something like "Git |
| 38 | [MosoFin/mosofin-finance-skills](https://github.com/MosoFin/mosofin-finance-skills) | 0 | — | 2026-09-01 | Read-only accounting skills for Claude, run against your own books through the MosoFin MCP gateway: month-end close, ban |
| 39 | [JhoseWolf/sageox-hivemind-engine](https://github.com/JhoseWolf/sageox-hivemind-engine) | 2 | HTML | 2026-09-01 | ⚡ SageOx HiveMind 2026 — Agentic Engineering Toolkit for Autonomous Workflows |
| 40 | [ashfaquecg806-dot/symfony-ux-insights](https://github.com/ashfaquecg806-dot/symfony-ux-insights) | 1 | HTML | 2026-09-01 | Symfony UX Skills Bundle 2026 - Master Live & Twig Components, Turbo, Stimulus |
| 41 | [int2t05/engineering-skills](https://github.com/int2t05/engineering-skills) | 3 | Python | 2026-09-01 | 47 engineering skills for Claude Code across the SDLC — shared principles injected at session start. Works with Codex, C |
| 42 | [themarmack/research-bot](https://github.com/themarmack/research-bot) | 0 | Python | 2026-09-01 | Claude Code skill toolkit for SDLC modernization in regulated environments — research digests, Copilot/GHAS governance,  |
...
| 44 | [M1LL4r3S-Droid/notion-sync-nexus](https://github.com/M1LL4r3S-Droid/notion-sync-nexus) | 0 | HTML | 2026-09-01 | Lafuanh Mind Bridge Connect 2026 - AI Knowledge Sync Without Sorting |
| 45 | [Darkmalan-1987/sparring-reason](https://github.com/Darkmalan-1987/sparring-reason) | 1 | HTML | 2026-09-01 | Claude Newton: AI Reasoning Partner 2026 - Calibrated Pushback & Current Sources |
| 46 | [LilityV/multai-ai-agent-arsenal](https://github.com/LilityV/multai-ai-agent-arsenal) | 0 | HTML | 2026-09-01 | MultAI Agent 2026: Autonomous Browser Engine with 7 AI Fallbacks & Comparator |
| 47 | [Rick-254/moodle-quizsmith](https://github.com/Rick-254/moodle-quizsmith) | 0 | HTML | 2026-09-01 | Claude Quiz Engine 2026 - Moodle MCQ Generator for GIFT XML Aiken |
| 48 | [OKHP3/skillz](https://github.com/OKHP3/skillz) | 2 | Python | 2026-09-01 | Agent Skills (SKILL.md) by OverKill Hill for Claude, OpenClaw, and Codex. BPMN-aware Mermaid diagramming, a LinkedIn voi |
| 49 | [phoebefu6/agent-skills-phoebe-picks](https://github.com/phoebefu6/agent-skills-phoebe-picks) | 1 | JavaScript | 2026-09-01 | Which AI agent Skills survive a real build? Every pick is field-tested by building a product from scratch, then rated on |
