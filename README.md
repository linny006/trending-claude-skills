...
| 22 | [jabrena/plinth](https://github.com/jabrena/plinth) | 425 | Java | 2026-08-16 | Plinth is an AI-native engineering toolkit for modern Java enterprise SDLC, built around reusable Commands, Agents, Skil |
...
| 25 | [code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) | 67933 | TypeScript | 2026-08-16 | omo/lazycodex: The coding agent for tokenmaxxers;the one and only agent harness for complex codebases. For your Codex, f |
| 26 | [JBSag/pm-artisan](https://github.com/JBSag/pm-artisan) | 1 | HTML | 2026-08-16 | 15 Claude Code PM Skills 2026 - Generate DOCX XLSX PPTX Artifacts Instantly |
...
| 28 | [Ford-1/postgresql-mcp-connector](https://github.com/Ford-1/postgresql-mcp-connector) | 0 | HTML | 2026-08-16 | PostgreSQL MCP 2026 Best AI Database Access Tool for Developers |
...
| 31 | [yngbrll/vb-winforms-toolkit](https://github.com/yngbrll/vb-winforms-toolkit) | 1 | HTML | 2026-08-16 | Modernize VB.NET WinForms Apps with Claude Code Skills on .NET 9 in 2026 |
| 32 | [hieu5882/telos-customer-validator](https://github.com/hieu5882/telos-customer-validator) | 0 | HTML | 2026-08-16 | The Art of Customer Validation: 2026’s Overlooked Startup Growth Filter |
...
| 36 | [wemwi/skill-library](https://github.com/wemwi/skill-library) | 1 | HTML | 2026-08-16 | Versionierte Heimat meiner Agent Skills für Claude (claude.ai, Claude Code, API). |
...
| 38 | [tamdogood/builder-essential-skills](https://github.com/tamdogood/builder-essential-skills) | 143 | Python | 2026-08-16 | A repository for skills that are essential to my daily work |
| 39 | [WardLu/skills](https://github.com/WardLu/skills) | 1 | Python | 2026-08-16 | Open-source, versioned skills for Codex and AI agent workflows — composable, tested, and safety-focused. |
...
| 43 | [martinholovsky/SOTA-skills](https://github.com/martinholovsky/SOTA-skills) | 13 | Python | 2026-08-16 | Engineering best practices that AI coding agents actually apply — 40+ skills, from secure coding and cloud to compliance |
| 44 | [JasonColapietro/suede-creator-skills](https://github.com/JasonColapietro/suede-creator-skills) | 151 | JavaScript | 2026-08-16 | 73 open-source Agent Skills for Claude Code and Codex: Full Send orchestration, A-F code review, AI evals, CI gates, des |
| 45 | [kakadeka/Baton](https://github.com/kakadeka/Baton) | 2 | JavaScript | 2026-08-16 | Pass your project, not your context. |
| 46 | [sup3x/claude-code-eco](https://github.com/sup3x/claude-code-eco) | 30 | JavaScript | 2026-08-16 | Eco mode for Claude Code. /eco: -31% to -73% output tokens with critical findings intact; /eco-max: up to -75% with lowe |
| 47 | [JhoseWolf/sageox-hivemind-engine](https://github.com/JhoseWolf/sageox-hivemind-engine) | 2 | HTML | 2026-08-16 | ⚡ SageOx HiveMind 2026 — Agentic Engineering Toolkit for Autonomous Workflows |
| 48 | [jonaskahn/docforge](https://github.com/jonaskahn/docforge) | 1 | Python | 2026-08-16 | 🤖 Just a skill to let AI generate documents based on your source code 🔅 |
...
| 50 | [celuk/claude-car](https://github.com/celuk/claude-car) | 0 | Python | 2026-08-16 | Claude Code - Continue After Reset command - Do not wait for limit reset |
<!-- TRACKER_TABLE_END -->
