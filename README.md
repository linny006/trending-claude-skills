...
| 19 | [tonydzi/oss-publish](https://github.com/tonydzi/oss-publish) | 0 | Python | 2026-09-23 | Open up your internal work without leaking it: substitute personal data with plausible fakes of the same shape (not <RED |
| 20 | [ilien-dev/quiron](https://github.com/ilien-dev/quiron) | 0 | Python | 2026-09-23 | AI humanizer skill for Claude Code, Codex and Cursor. Removes AI slop and the signs of AI writing, then measures the rew |
| 21 | [tonydzi/fleet-deploy](https://github.com/tonydzi/fleet-deploy) | 0 | Python | 2026-09-23 | Roll a fix to N machines and prove it landed on each one: applied-vs-claimed accounting, canary waves, a verify that mus |
...
| 23 | [tonydzi/claw-consensus](https://github.com/tonydzi/claw-consensus) | 4 | Python | 2026-09-23 | Run AI agents across machines without state drift: consensus protocol (propose/counter/accept/commit), dual-rail message |
| 24 | [tonydzi/claude-mac-patrol](https://github.com/tonydzi/claude-mac-patrol) | 0 | Python | 2026-09-23 | Your Mac is not old -- it is holding thirty half-dead agent sessions. A dependency-free janitor for machines running Cla |
| 25 | [tonydzi/awesome-verified-agents](https://github.com/tonydzi/awesome-verified-agents) | 1 | — | 2026-09-23 | Tools that produce evidence about what an AI agent actually did — gates, attestation, output verification, benchmarks. I |
| 26 | [tonydzi/agent-runtime-integrity-bench](https://github.com/tonydzi/agent-runtime-integrity-bench) | 0 | Python | 2026-09-23 | Integrity scenarios for agent runtimes, distilled from real fleet incidents — deterministic fault-injection checks again |
| 27 | [hieu5882/telos-customer-validator](https://github.com/hieu5882/telos-customer-validator) | 0 | HTML | 2026-09-23 | The Art of Customer Validation: 2026’s Overlooked Startup Growth Filter |
| 28 | [martinambrus/haive](https://github.com/martinambrus/haive) | 5 | TypeScript | 2026-09-23 | Project orchestration and AI agentic workflow utility. |
| 29 | [zhuhrymhd/testcase-artisan](https://github.com/zhuhrymhd/testcase-artisan) | 0 | — | 2026-09-23 |  |
| 30 | [elsoul/erpc-sdk](https://github.com/elsoul/erpc-sdk) | 2 | JavaScript | 2026-09-23 | ERPC Official Multi-Network Blockchain SDK Built for Developers. Ready for AI Agents. |
| 31 | [bokyostudio/pg-practice-knowledgebase](https://github.com/bokyostudio/pg-practice-knowledgebase) | 0 | HTML | 2026-09-23 | The Ultimate guide to PostgreSQL Optimization for AI Code Generation in 2026 |
| 32 | [mohamoudj6-del/AlterLab-FC-Agent-Playbook](https://github.com/mohamoudj6-del/AlterLab-FC-Agent-Playbook) | 0 | HTML | 2026-09-23 | AlterLab FC 2026 AI Playbook 🚀 Ultimate Skills & Strategy Guide |
| 33 | [nikolai-vysotskyi/trace-mcp](https://github.com/nikolai-vysotskyi/trace-mcp) | 181 | TypeScript | 2026-09-23 | Framework-aware code intelligence MCP server — 88 framework integrations, 81 languages, 72.7% fewer input tokens to revi |
| 34 | [drnachio/postext](https://github.com/drnachio/postext) | 5 | TypeScript | 2026-09-23 | A programmable typesetter for the web |
| 35 | [rokokol/bash-best-practices-skill](https://github.com/rokokol/bash-best-practices-skill) | 0 | Shell | 2026-09-23 | A standard for shell utilities: one shape, help as the truth, the bash macOS ships |
| 36 | [SentiSenseApp/skills](https://github.com/SentiSenseApp/skills) | 2 | Python | 2026-09-23 | The financial-analysis skill collection for AI agents: sentiment, smart money, filings, and an adversarial investment co |
| 37 | [SELAT-AI/selat-skills](https://github.com/SELAT-AI/selat-skills) | 2 | JavaScript | 2026-09-23 |  |
| 38 | [nota-america/forgecat-agent-profiles](https://github.com/nota-america/forgecat-agent-profiles) | 84 | TypeScript | 2026-09-23 | Production-ready AI agent profiles for Claude Code, Cursor, Codex, OpenClaw, and Hermes. Search, install, and contribute |
| 39 | [SDuarteCorredor/vertical-video-kit](https://github.com/SDuarteCorredor/vertical-video-kit) | 1 | Python | 2026-09-23 | Make TikToks, Reels and Shorts in code: natural AI narration, word-by-word captions, and real 1080x1920 Remotion renders |
| 40 | [docsor1212/paper-rewriter](https://github.com/docsor1212/paper-rewriter) | 0 | Python | 2026-09-23 | paper-rewriter — Agent Skill (SKILL.md open format) |
| 41 | [yegor256/courier](https://github.com/yegor256/courier) | 3 | — | 2026-09-23 | A skill for an AI agent to help it create well documented and clean pull requests |
| 42 | [jasonmaggio-cur8tr/ai-operator-skills](https://github.com/jasonmaggio-cur8tr/ai-operator-skills) | 0 | — | 2026-09-23 | Four skills for running a small business with AI — find the work worth automating, tighten it, and make it repeatable. |
| 43 | [n-shadloo/secure-code-auditor](https://github.com/n-shadloo/secure-code-auditor) | 4 | Python | 2026-09-23 | Backend security Agent Skill that helps AI audit code, detect vulnerabilities, and generate secure-by-default backend ap |
| 44 | [ALKwbfkAgbfcAGIB/claude-cli-mcp-bridge](https://github.com/ALKwbfkAgbfcAGIB/claude-cli-mcp-bridge) | 54 | HTML | 2026-09-23 | Claude Code CLI 2026 Pro Edition – Next-Gen AI Development Workflow Tool |
| 45 | [ormeilu/avoid-ai-writing-russian](https://github.com/ormeilu/avoid-ai-writing-russian) | 0 | TypeScript | 2026-09-23 | Скилл для ИИ-агентов и детектор на TypeScript/Bun: убирает ИИ-стиль из русских текстов (канцелярит, кальки, штампы) и го |
| 46 | [yegor256/bugscribe](https://github.com/yegor256/bugscribe) | 2 | — | 2026-09-23 | A collection of skills for an AI agent that helps filing bug reports as GitHub issues |
...
| 49 | [MauricioQuezadaHaintech/karvey](https://github.com/MauricioQuezadaHaintech/karvey) | 0 | HTML | 2026-09-23 | Karvey — método spec-driven development agnóstico de stack (Afán, selknam). Plugin de Claude Code. © HainTech, Apache 2. |
| 50 | [HABUBUSS/everything-claude-code](https://github.com/HABUBUSS/everything-claude-code) | 0 | JavaScript | 2026-09-23 | Discover production-ready Claude Code configs: agents, skills, hooks, commands, rules, and MCP setups from an Anthropic  |
<!-- TRACKER_TABLE_END -->
