...
| 32 | [kierstenicy452/anti-ai-writing](https://github.com/kierstenicy452/anti-ai-writing) | 0 | — | 2026-08-17 | Remove AI patterns and robotic phrasing from your drafts to restore a natural human voice. |
| 33 | [aerovato/container](https://github.com/aerovato/container) | 332 | TypeScript | 2026-08-17 | Safely run OpenCode, Codex, Claude Code with full permissions. |
| 34 | [flakey-caster542/superseo-skills](https://github.com/flakey-caster542/superseo-skills) | 1 | — | 2026-08-17 | Automate SEO audits, briefs, and content strategy using eleven production-tested Claude skills that perform independent  |
| 35 | [aaron-he-zhu/aaron-marketing-skills](https://github.com/aaron-he-zhu/aaron-marketing-skills) | 2598 | Python | 2026-08-17 | 120 marketing skills + 8 commands for Claude Code & AI agents across 7 disciplines — SEO/GEO, influencer, paid ads, emai |
| 36 | [felipedeso7za4444/scientific-thinking-general](https://github.com/felipedeso7za4444/scientific-thinking-general) | 0 | — | 2026-08-17 | Apply structured scientific reasoning to AI agents to decompose questions, verify claim provenance, and rank explanation |
| 37 | [Ocean1346/bigquery-expert](https://github.com/Ocean1346/bigquery-expert) | 1 | — | 2026-08-17 | Automate BigQuery tasks with Claude Code. Use this plugin to generate SQL, optimize costs, design schemas, and detect an |
| 38 | [Ikramahmadmemon13/grant-thinking-skill](https://github.com/Ikramahmadmemon13/grant-thinking-skill) | 0 | — | 2026-08-17 | Evaluate project fundability and refine grant logic using AI agent skills to identify innovation, assess feasibility, an |
| 39 | [JhoseWolf/sageox-hivemind-engine](https://github.com/JhoseWolf/sageox-hivemind-engine) | 2 | HTML | 2026-08-17 | ⚡ SageOx HiveMind 2026 — Agentic Engineering Toolkit for Autonomous Workflows |
| 40 | [Jartan-LLC/grimoire](https://github.com/Jartan-LLC/grimoire) | 2 | JavaScript | 2026-08-17 | Where Merlin keeps his spells, for Claude Code and Codex. |
| 41 | [ashfaquecg806-dot/symfony-ux-insights](https://github.com/ashfaquecg806-dot/symfony-ux-insights) | 1 | HTML | 2026-08-17 | Symfony UX Skills Bundle 2026 - Master Live & Twig Components, Turbo, Stimulus |
| 42 | [close-shellflower7762/e2e-tester](https://github.com/close-shellflower7762/e2e-tester) | 0 | — | 2026-08-17 | Automate E2E Playwright tests and Lighthouse performance audits directly within Cursor using a simple slash command. |
| 43 | [briefless-orgasm922/claude-code-t8](https://github.com/briefless-orgasm922/claude-code-t8) | 0 | — | 2026-08-17 | Run Claude Code locally with TUI and Electron desktop support, plus flexible Anthropic/OpenAI-compatible API access and  |
| 44 | [aymannaim822-create/claude-code-source](https://github.com/aymannaim822-create/claude-code-source) | 0 | — | 2026-08-17 | Restore and run Claude Code source with full native modules, types, and internals for local use and MCP mode |
| 45 | [vmy41/agent-harness](https://github.com/vmy41/agent-harness) | 1 | — | 2026-08-17 | Build coding agents with a clean-room harness for streaming loops, tool control, session save, secure creds, and layered |
| 46 | [Sleeknessbounder869/miniClaudeCode](https://github.com/Sleeknessbounder869/miniClaudeCode) | 0 | — | 2026-08-17 | Build a tiny Claude Code clone in Python with agent loop, tools, permissions, and context management in ~800 lines |
| 47 | [Angeliquetreated862/claude-code-src](https://github.com/Angeliquetreated862/claude-code-src) | 2 | TypeScript | 2026-08-17 | Explore a public Claude Code source snapshot for security research, supply-chain analysis, and CLI architecture review |
| 48 | [Raflimoon/learn-real-claude-code](https://github.com/Raflimoon/learn-real-claude-code) | 0 | TypeScript | 2026-08-17 | Explore Claude Code source code to learn how Anthropic’s CLI harness works, from tools and permissions to context and st |
| 49 | [Defiladeboarfish90/agent-memory](https://github.com/Defiladeboarfish90/agent-memory) | 2 | TypeScript | 2026-08-17 | Store persistent AI agent memory in Markdown files with search, context injection, checkpoints, and compaction—no databa |
| 50 | [Nonpregnant-loss29/not-claude-code-emulator](https://github.com/Nonpregnant-loss29/not-claude-code-emulator) | 0 | — | 2026-08-17 | Proxy Claude Code-style OAuth and Messages API with token management and streaming support built on Bun and Hono |
<!-- TRACKER_TABLE_END -->
